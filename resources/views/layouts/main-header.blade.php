    ...
    <div class="container-fluid">
        <div class="main-header-left ">
            <div class="responsive-logo">
                <a href="{{ url('/' . ($page = 'dashboard')) }}"><img src="{{ URL::asset('assets/img/brand/logo.png') }}"
                        ...
                        <div class="dropdown-menu">
                            <div class="menu-header-content bg-primary text-right">
                                <div class="d-flex">
                                    ...
                                    <a class="badge badge-pill badge-warning mr-auto my-auto float-left"
                                        href="{{ route('MarkAsRead_all') }}">تعيين قراءة
                                        الكل</a>

                                </div>
                                <p class="dropdown-title-text subtext mb-0 text-white op-6 pb-0 tx-12 ">
                                <h6 style="color: yellow" id="notification_count">
                            ...
                            <div class="main-notification-list Notification-scroll" id="unreadNotifications">
                                @foreach (auth::user()->unreadNotifications as $noti)
                                    <a class="d-flex p-3 border-bottom" href="{{ route('MarkAsRead', $noti->id) }}">
                                        <div class="mr-3">
                                            <h5 class="notification-label mb-1"> {{ $noti->data['title'] }}
                                                {{ $noti->data['user'] }}</h5>
                ...
                <div class="dropdown main-profile-menu nav nav-item nav-link">
                    ...
                    <div class="dropdown-menu">
                        ...
                        <form class="dropdown-item" action="{{ route('logout') }}" method="POST">
                            @csrf
                            <button type="submit" class="dropdown-item" style="background: none;  padding: 0;">
