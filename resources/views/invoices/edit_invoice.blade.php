                    ...
                    <form action="{{ route('invoices.update', $invoices->id) }}" method="post"
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="hidden" class="form-control" id="id" name="invoice_id"
                                    value="{{ $invoices->id }}">
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <input type="text" class="form-control form-control-lg" id="Discount"
                                    name="Discount" value="{{ $invoices->Discount }}" title="يرجي ادخال مبلغ الخصم "
                                    oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"
                                    value=0 required>
                            </div>
                            ...
                            <div class="col">
                                ...
                                <select name="Rate_VAT" id="Rate_VAT" class="form-control"
                                    value={{ $invoices->Rate_VAT }} onchange="myFunction()">
                                    <!--placeholder-->
    ...
    <script>
        function myFunction() {
            ...
            if (typeof Amount_Commission === 'undefined' || !Amount_Commission) {
                alert('يرجي تحديد قيمة العمولة ');
            } else {
                Value_VAT = (Amount_Commission - Discount) * Rate_VAT / 100;
                Total = (Amount_Commission - Discount) + Value_VAT;
